...
<html lang="en" >
        ...
        <link rel='stylesheet' href='https://cdn.datatables.net/buttons/1.2.2/css/buttons.bootstrap.min.css'>
          <style>
            ...
            form input[type="date"] {
                ...
                font-size: 16px;
                opacity: 0;
                animation: fadeInInput 1.5s forwards 0.5s;
            }
            ...
            form input[type="submit"] {
                ...
                cursor: pointer;
                opacity: 0;
                animation: fadeInInput 1.5s forwards 1s;
            }
            ...
            table {
                ...
                opacity: 0;
                animation: fadeInTable 1.5s forwards 1.5s;
            }
            ...
            table td {
                ...
                font-size: 16px;
                opacity: 0;
                animation: fadeInTableCells 1s forwards 1.5s;
            }
    ...
    <body>
        ...
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
			...
			<?php 
				$i=0;
			 $selQry = "select * from tbl_booking b inner join tbl_cart c on b.booking_id=c.booking_id inner join tbl_product p on p.product_id=c.product_id inner join tbl_trader t on t.trader_id = p.trader_id inner join tbl_user u on u.user_id=b.user_id where true and booking_status > 0 and cart_status > 0 and t.trader_id = '".$_SESSION['tid']."'";
			...
			?>
              <tr>
                 ...
                 <td align="center"><?php echo $data["trader_name"]; ?></td>
