...
if(isset($_POST["txt_submit"]))
{
	...
	$insQry = "insert  into tbl_user(user_name, user_email, user_contact, user_address, user_password, user_photo, place_id)
...
<body>
  <section class="container" style="margin-top: 30px;">
    <header class="header">Register Now as an User</header>
