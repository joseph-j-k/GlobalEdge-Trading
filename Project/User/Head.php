...
<html lang="en">
  <head>
    ...
    <!-- CSS Libraries -->
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.10.0/css/all.min.css" rel="stylesheet"><!---rating link --->
              ...
              <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                ...
                <div class="offcanvas-body">
                  ...
                  <ul class="navbar-nav justify-content-end menu-list list-unstyled d-flex gap-md-3 mb-0">
                    ...
                    <li class="nav-item">
                      <a href="SearchProduct.php" class="nav-link">Search Product</a>
                    </li>
                    <li class="nav-item">
                      <a href="MyCart.php" class="nav-link">My Cart</a>
                    </li>
                    <li class="nav-item">
                      <a href="MyBooking.php" class="nav-link">My booking</a>
                    </li>
                    <li class="nav-item">
