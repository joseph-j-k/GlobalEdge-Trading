    ...
    <body>
        ...
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
			...
			<?php
				...
				$i=0;
			 $selQry = "select * from tbl_booking b inner join tbl_cart c on b.booking_id = c.booking_id inner join tbl_product p on p.product_id = c.product_id inner join tbl_shop s on s.shop_id = p.shop_id inner join tbl_user u on u.user_id = b.user_id where true and booking_status > 0 and cart_status > 0";
				 ...
				 $selQry = $selQry." and booking_date between '".$_POST["fdate"]."' and '".$_POST["tdate"]."'";
				  ...
				  $rs = $conn -> query($selQry);
                   while($data = $rs -> fetch_assoc()) 
				   {
					   ...
					   $amt = $data["product_price"] * $data["cart_qty"];
			...
			?>
              <tr>
                 ...
                 <td align="center"><?php echo $data["cart_qty"]; ?></td>
